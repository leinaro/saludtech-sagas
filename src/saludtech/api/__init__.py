...
def registrar_handlers():
    import saludtech.modulos.vuelos.aplicacion
    import processed_data.modulos.aplicacion
...
def comenzar_consumidor(app):
    ...
    import threading
    import saludtech.modulos.hoteles.infraestructura.consumidores as hoteles
    import saludtech.modulos.vehiculos.infraestructura.consumidores as vehiculos
    import saludtech.modulos.vuelos.infraestructura.consumidores as vuelos
...
def create_app(configuracion={}):
    ...
    with app.app_context():
        ...
        from saludtech.modulos.sagas.aplicacion.coordinadores.saga_reservas import CoordinadorReservas
        CoordinadorReservas()
