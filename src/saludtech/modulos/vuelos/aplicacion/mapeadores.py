...
from saludtech.modulos.vuelos.dominio.entidades import Reserva, Aeropuerto
from saludtech.modulos.vuelos.dominio.objetos_valor import Itinerario, Odo, Segmento, Leg
