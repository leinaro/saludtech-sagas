...
from saludtech.modulos.vuelos.aplicacion.dto import ItinerarioDTO, ReservaDTO
...
from saludtech.modulos.vuelos.infraestructura.repositorios import RepositorioReservas, RepositorioEventosReservas
